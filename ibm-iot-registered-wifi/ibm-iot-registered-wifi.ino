...
#define CLIENT_ID "d:c9ya4g:arduino-wifi:90a2da0fcede"
#define MS_PROXY "c9ya4g.messaging.internetofthings.ibmcloud.com"
#define AUTHTOKEN "i6F6jD-m*90IVc+NIy"
// Update these with values suitable for your network.
byte mac[] = { 0x90, 0xa2, 0xda, 0x0f, 0xce, 0xde };

//char ssid[] = "CoboFree";      // your network SSID (name)
char ssid[] = "jbjak's iPhone5s";      // your network SSID (name)
//char ssid[] = "J_wireless";      // your network SSID (name)
char pass[] = "jakub1ak";        // your network password
...
void loop() {
  ...
  if (!client.isConnected()) {
    Serial.print("Connecting using Registered mode\n\twith clientid : ");
